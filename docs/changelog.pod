...
Added Secret directive to t/ssl_conf.t config to make tests run
smoothly. [Bodo Schulze]

=item *

Added platform files for Fedora Core 7.  [Jesse Erlbaum]
...
Completely new skin. [Don Brodale and Michael Peters]
...
After you've already built Krang C<--with--ssl>, if you do a C<krang_build
--rebuild> it will do the rebuild C<--with-ssl> too. [Michael Peters]
