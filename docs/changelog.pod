...
file creationdates, logging, etc.) was always UTC regardless of 
the local machine'stimezone (causing inconsistency in Krang dates 
...
a smoke serveri to send the results to L<http://smolder.plusthree.com>. 
[Michael Peters]
