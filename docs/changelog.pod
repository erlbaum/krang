...
from conflicting with existing categories, and new categories
from conflicting with existing stories. [Noam Weinstein]
...
Implemented first version of auto-slug-generation based on title
and story type. [Noam Weinstein]
