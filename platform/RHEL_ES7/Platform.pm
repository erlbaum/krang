...
sub guess_platform {
    ...
    my $release = <RELEASE>;
    close RELEASE;
    return 1 if $release =~ /Red Hat Enterprise Linux Server release 6/;
    return 1 if $release =~ /CentOS Linux release 7/;
    return 0;
}
...
# Overridden to correctly detect mysql-devel package on RH ES7 / x86_64
...
sub finish_installation {
    ...
    print q{
      ...
      # TODO:
      #
      #   Setup systemd-style controls for krang, so that e.g.
      #
      #     systemctl enable krang.service
      #     systemctl start krang.service
      #     systemctl status krang.service
      #
      #  work (as they do for the httpd.service).
      #
    };
